...
// Pin macros
    ...
    #define I2C_Read_SDA()      GPIO_PA_Read_Pins(PIN_SDA)
#else
    #define PIN_SDA             (1 << I2C_SDA_PB)
    ...
    #define I2C_Read_SDA()      GPIO_PB_Read_Pins(PIN_SDA)
#endif

#if defined(I2C_SCL_PA)
    #define PIN_SCL             (1 << I2C_SCL_PA)
